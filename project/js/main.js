  ...
  results.map((result) => {
    generatedHTML += `
      <div class="item">
        ...
        <p class="item-data"> ${result.recipe.totalNutrients.CHOCDF.label}:${result.recipe.totalNutrients.CHOCDF.quantity.toFixed(2)}Grams</p>
        <p class="item-data"> ${result.recipe.totalNutrients.FAT.label}:${result.recipe.totalNutrients.FAT.quantity.toFixed(2)}Grams</p>
        <p class="item-data"> ${result.recipe.totalNutrients.FIBTG.label}:${result.recipe.totalNutrients.FIBTG.quantity.toFixed(2)}Grams</p>
        <p class="item-data"> ${result.recipe.totalNutrients.SUGAR.label}:${result.recipe.totalNutrients.SUGAR.quantity.toFixed(2)}Grams</p>
